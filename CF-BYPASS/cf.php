...
if($proxy != null){
	...
	echo $colors->getColoredString("Terminal X - CF ByPass\n", "light_red", null) . "\n";

if(!isset($argv[1]) || !isset($argv[2]) || !isset($argv[3]) || !isset($argv[4])){
	//echo $colors->getColoredString("Usage: php " . $argv[0] . " [URL] [THREADS] [SECONDS] [CLIENTS_NUMBER] [PROXY_FILE]", "light_green", null) . "\n";
	echo $colors->getColoredString("Example: php " . $argv[0] . " http://muthrones.net/ 800 60 20 proxies.txt", "light_green", null) . "\n";
	die();
}
